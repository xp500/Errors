...
public final class Errors {
    ...
    /**
     * Marker interface that represents {@link ErrorOr<E>} objects where the
     * {@code or} is void.
     * 
     * <p>
     * The typical use case for this interface is when a method returns void.
     * For example
     * 
     * <pre>
     * {@code
    ...
    /**
     * Marker interface that represents {@link ErrorOr<E>} objects where the
     * {@code or} is an object of type {@code T}.
     * 
     * <p>
     * The typical use case for this interface is when a method returns an
     * object, but there could be errors. For example
     * 
     * <pre>
     * {@code
     ...
     * 
     * @param value
     *            the value with which the {@code ErrorOrValue<E, T>} object
     *            will be initialized.
    ...
    /**
     * Creates an {@code ErrorOrVoid<E>} object with no value, but that is not
     * an error. This factory method can be used when a method should return
     * {@code void} in case of success.
     * 
     ...
     * 
     * @param error
     *            the error with which the {@code ErrorOrVoid<E>} object will be
     *            initialized.
     ...
     * 
     * @param error
     *            the error with which the {@code ErrorOrValue<E, T>} object
     *            will be initialized.
	...
	@Override
	public <T1> ReturnElseExecutor<T1, FunctionWithReturnValue<T1>> ifErrorReturn(final OneArgFunction<E, T1> function) {
	...
	@Override
	public <T, F extends FunctionWithReturnValue<T>> ReturnElseExecutor<T, F> ifErrorReturn(final OneArgFunction<E, T> function) {
	...
	private ValueErrorImpl(final E error) {
	    super(error);
	}
    }
	...
	private VoidErrorImpl(final E error) {
	    super(error);
	}
    }
